r"""DEFAULT COLLATE FROM PYTORCH - Modified to also ignore Timer and MultiLevelTimer.
If anything goes wrong, you should be able to copy the corresponding `default_collate` file from the PyTorch version
you are using and add the single `if` block to filter out MultiLevelTimer as in this example.
